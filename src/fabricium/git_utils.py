"""Git subprocess wrappers for Hermes plugins.
...
Based on the Jovaltus version (more complete — includes diff helpers,
commit helpers, and ancestor checks in addition to the remote update
utilities shared with Caelterra).
"""
